// Obfuscated version of temp_custom_input.c
// Applied passes: control_flow_bogus_control_flow, data_string_encryption, instruction_instruction_substitution, control_flow_flattening
/**
 ...
 */
int main() {
    const char* secret = "[ENCRYPTED]This is a secret message"[ENCRYPTED];
    int value = 10;
    
    printf("[ENCRYPTED]Starting computation...\n"[ENCRYPTED]);
